        ...
        <section className="px-4 py-10 xl:px-[125px]">
            <div className="container mx-auto">
                ...
                <p className="mx-auto max-w-[700px] py-6 text-center text-sm leading-6 md:text-base md:leading-7">
                    ...
                    experience, our team of experts leverages deep industry
                    knowledge and innovative technology to tackle the most
                    complex challenges, ensuring operational excellence and
                    strategic growth for our clients worldwide. We are committed
                    to fostering a safer, more productive, and environmentally
